...
<body>
  ...
  { "en": "Apa Itu Logika Fuzzy?", "id": "Logika Yang Menangani Konsep Kebenaran Parsial." },
  { "en": "Siapa Penggagas Logika Fuzzy?", "id": "Lotfi A. Zadeh." },
  { "en": "Apa Perbedaan Utama Dengan Logika Klasik?", "id": "Logika Klasik Biner, Fuzzy Multi-nilai." },
  { "en": "Apa Itu Himpunan Fuzzy?", "id": "Himpunan Dengan Derajat Keanggotaan." },
  { "en": "Apa Itu Himpunan Krisp (Crisp Set)?", "id": "Himpunan Dalam Logika Klasik." },
  { "en": "Apa Itu Derajat Keanggotaan?", "id": "Nilai Antara Nol Dan Satu." },
  { "en": "Apa Arti Derajat Keanggotaan Satu?", "id": "Sepenuhnya Menjadi Anggota Himpunan." },
  { "en": "Apa Arti Derajat Keanggotaan Nol?", "id": "Sepenuhnya Bukan Anggota Himpunan." },
  { "en": "Apa Itu Fungsi Keanggotaan?", "id": "Kurva Yang Mendefinisikan Himpunan Fuzzy." },
  { "en": "Sebutkan Bentuk Fungsi Keanggotaan Umum?", "id": "Segitiga, Trapesium, Dan Gaussian." },
  { "en": "Apa Itu Variabel Linguistik?", "id": "Variabel Yang Nilainya Adalah Kata." },
  { "en": "Berikan Contoh Variabel Linguistik?", "id": "Suhu, Kecepatan, Atau Tinggi." },
  { "en": "Apa Itu Istilah Linguistik?", "id": "Nilai Dari Variabel Linguistik." },
  { "en": "Berikan Contoh Istilah Linguistik?", "id": "Dingin, Sedang, Panas." },
  { "en": "Apa Itu Fuzzifikasi?", "id": "Proses Mengubah Input Krisp Menjadi Fuzzy." },
  { "en": "Apa Itu Input Krisp?", "id": "Nilai Numerik Tepat (Contoh: 25°C)." },
  { "en": "Apa Itu Sistem Inferensi Fuzzy (FIS)?", "id": "Sistem Pengambilan Keputusan Berbasis Aturan." },
  { "en": "Apa Tiga Bagian Utama FIS?", "id": "Fuzzifikasi, Mesin Inferensi, Defuzzifikasi." },
  { "en": "Apa Itu Basis Aturan (Rule Base)?", "id": "Kumpulan Aturan JIKA-MAKA." },
  { "en": "Apa Format Aturan Fuzzy?", "id": "JIKA (Antecedent) MAKA (Consequent)." },
  { "en": "Apa Itu Antecedent?", "id": "Bagian 'JIKA' Dari Aturan." },
  { "en": "Apa Itu Consequent?", "id": "Bagian 'MAKA' Dari Aturan." },
  { "en": "Apa Itu Mesin Inferensi?", "id": "Mengevaluasi Aturan Fuzzy Untuk Membuat." },
  { "en": "Apa Itu Operator Logika Fuzzy?", "id": "AND, OR, NOT." },
  { "en": "Bagaimana Operator AND Fuzzy Bekerja?", "id": "Biasanya Menggunakan Nilai Minimum (Min)." },
  { "en": "Bagaimana Operator OR Fuzzy Bekerja?", "id": "Biasanya Menggunakan Nilai Maksimum (Max)." },
  { "en": "Apa Itu Implikasi?", "id": "Proses Membentuk Output Fuzzy." },
  { "en": "Apa Itu Agregasi?", "id": "Proses Menggabungkan Semua Output Fuzzy." },
  { "en": "Apa Hasil Dari Agregasi?", "id": "Satu Himpunan Fuzzy Gabungan." },
  { "en": "Apa Itu Defuzzifikasi?", "id": "Proses Mengubah Output Fuzzy Menjadi Krisp." },
  { "en": "Apa Itu Output Krisp?", "id": "Nilai Numerik Tepat Sebagai Hasil Akhir." },
  { "en": "Sebutkan Metode Defuzzifikasi Populer?", "id": "Centroid, Bisector, Mean of Maximum." },
  { "en": "Apa Itu Metode Centroid?", "id": "Menghitung Pusat Massa Himpunan Fuzzy." },
  { "en": "Apa Itu Semesta Pembicaraan (Universe of Discourse)?", "id": "Rentang Semua Nilai Mungkin Untuk Variabel." },
  { "en": "Apa Itu Support Dari Himpunan Fuzzy?", "id": "Wilayah Dengan Keanggotaan Lebih Besar Nol." },
  { "en": "Apa Itu Core Dari Himpunan Fuzzy?", "id": "Wilayah Dengan Keanggotaan Sama Dengan Satu." },
  { "en": "Apa Itu Crossover Point?", "id": "Titik Dengan Derajat Keanggotaan 0.5." },
  { "en": "Apa Itu Himpunan Fuzzy Normal?", "id": "Himpunan Fuzzy Dengan Tinggi Satu." },
  { "en": "Apa Itu Himpunan Fuzzy Subnormal?", "id": "Himpunan Fuzzy Dengan Tinggi Kurang Satu." },
  { "en": "Apa Itu Operasi Himpunan Fuzzy?", "id": "Union, Intersection, Complement." },
  { "en": "Apa Itu Union Himpunan Fuzzy?", "id": "Menggunakan Operator OR (Max)." },
  { "en": "Apa Itu Intersection Himpunan Fuzzy?", "id": "Menggunakan Operator AND (Min)." },
  { "en": "Apa Itu Complement Himpunan Fuzzy?", "id": "Satu Dikurangi Derajat Keanggotaan." },
  { "en": "Apa Itu Model Fuzzy Mamdani?", "id": "Jenis FIS Dimana Outputnya Himpunan." },
  { "en": "Apa Itu Model Fuzzy Sugeno?", "id": "Jenis FIS Dimana Outputnya Fungsi." },
  { "en": "Apa Nama Lain Model Sugeno?", "id": "Model Fuzzy TSK (Takagi-Sugeno-Kang)." },
  { "en": "Mana Yang Lebih Efisien Secara Komputasi?", "id": "Model Sugeno Umumnya Lebih Efisien." },
  { "en": "Apa Itu Kontrol Logika Fuzzy (FLC)?", "id": "Aplikasi Logika Fuzzy Dalam Sistem Kontrol." },
  { "en": "Apa Keuntungan Kontrol Fuzzy?", "id": "Dapat Mengontrol Sistem Non-linier." },
  { "en": "Apakah Kontrol Fuzzy Membutuhkan Model Matematika?", "id": "Tidak, Berdasarkan Aturan Heuristik." },
  { "en": "Di Mana Logika Fuzzy Digunakan?", "id": "Kontrol Mesin Cuci, AC, Transmisi." },
  { "en": "Apa Itu Relasi Fuzzy?", "id": "Himpunan Fuzzy Dalam Ruang Produk." },
  { "en": "Apa Itu Komposisi Relasi Fuzzy?", "id": "Menggabungkan Dua Relasi Fuzzy." },
  { "en": "Apa Itu Komposisi Max-Min?", "id": "Metode Komposisi Relasi Fuzzy." },
  { "en": "Apa Itu Bilangan Fuzzy?", "id": "Himpunan Fuzzy Di Garis Bilangan." },
  { "en": "Apa Ciri Bilangan Fuzzy?", "id": "Normal Dan Konveks." },
  { "en": "Apa Itu Himpunan Fuzzy Konveks?", "id": "Fungsi Keanggotaan Tidak Memiliki Lembah." },
  { "en": "Apa Itu Aritmetika Fuzzy?", "id": "Operasi Aritmetika Pada Bilangan Fuzzy." },
  { "en": "Apa Itu Prinsip Ekstensi?", "id": "Memperluas Fungsi Krisp Ke Domain Fuzzy." },
  { "en": "Apa Itu Klastering Fuzzy?", "id": "Metode Klastering Dengan Keanggotaan Parsial." },
  { "en": "Apa Itu Algoritma Fuzzy C-Means (FCM)?", "id": "Algoritma Klastering Fuzzy Populer." },
  { "en": "Apa Beda Klastering K-Means Dan FCM?", "id": "K-Means Krisp, FCM Fuzzy." },
  { "en": "Apa Itu Jaringan Saraf Fuzzy?", "id": "Sistem Hibrida Menggabungkan Keduanya." },
  { "en": "Apa Itu ANFIS (Adaptive Neuro-Fuzzy Inference System)?", "id": "Contoh Jaringan Saraf Fuzzy." },
  { "en": "Apa Itu Alpha-Cut?", "id": "Himpunan Krisp Dengan Keanggotaan Di Atas." },
  { "en": "Apa Itu Strong Alpha-Cut?", "id": "Keanggotaan Harus Lebih Besar." },
  { "en": "Apa Itu Kernel Himpunan Fuzzy?", "id": "Sinonim Untuk Core." },
  { "en": "Apa Itu Ukuran Skalar Himpunan Fuzzy?", "id": "Kardinalitas Himpunan Fuzzy." },
  { "en": "Apa Itu Entropi Fuzzy?", "id": "Ukuran Keketidakjelasan (Fuzziness)." },
  { "en": "Apa Itu T-Norm?", "id": "Generalisasi Operator AND." },
  { "en": "Sebutkan Contoh T-Norm?", "id": "Minimum, Produk, Dan Lukasiewicz." },
  { "en": "Apa Itu T-Conorm (S-Norm)?", "id": "Generalisasi Operator OR." },
  { "en": "Sebutkan Contoh S-Norm?", "id": "Maksimum, Jumlah Probabilistik." },
  { "en": "Apa Itu Fungsi Implikasi Fuzzy?", "id": "Merepresentasikan Aturan JIKA-MAKA." },
  { "en": "Apa Itu Hedge Linguistik?", "id": "Modifier Seperti 'Sangat' Atau 'Agak'." },
  { "en": "Bagaimana Cara Kerja Hedge 'Sangat'?", "id": "Mengkuadratkan Derajat Keanggotaan." },
  { "en": "Bagaimana Cara Kerja Hedge 'Agak'?", "id": "Mengambil Akar Kuadrat Derajat." },
  { "en": "Apa Itu Tuning Sistem Fuzzy?", "id": "Menyesuaikan Aturan Atau Fungsi Keanggotaan." },
  { "en": "Apa Itu Logika Fuzzy Tipe-2?", "id": "Derajat Keanggotaan Adalah Himpunan Fuzzy." },
  { "en": "Untuk Apa Logika Fuzzy Tipe-2?", "id": "Menangani Tingkat Ketidakpastian Lebih Tinggi." },
  { "en": "Apa Itu Singleton?", "id": "Himpunan Fuzzy Dengan Satu Titik." },
  { "en": "Di Mana Singleton Digunakan?", "id": "Dalam Fuzzifikasi Input Krisp." },
  { "en": "Apa Itu Himpunan Fuzzy Segitiga?", "id": "Didefinisikan Oleh Tiga Titik." },
  { "en": "Apa Itu Himpunan Fuzzy Trapesium?", "id": "Didefinisikan Oleh Empat Titik." },
  { "en": "Apa Itu Fungsi Keanggotaan Gaussian?", "id": "Berbentuk Kurva Lonceng." },
  { "en": "Apa Itu Fungsi Keanggotaan Sigmoid?", "id": "Berbentuk Kurva S." },
  { "en": "Apa Itu Partisi Fuzzy?", "id": "Membagi Semesta Pembicaraan Menjadi." },
  { "en": "Apa Itu Partisi Kuat?", "id": "Jumlah Keanggotaan Selalu Satu." },
  { "en": "Apa Itu Pengambilan Keputusan Fuzzy?", "id": "Membuat Keputusan Dengan Kriteria Fuzzy." },
  { "en": "Apa Itu Basis Data Fuzzy?", "id": "Basis Data Yang Dapat Menyimpan." },
  { "en": "Apa Itu Kueri Fuzzy?", "id": "Kueri Yang Menggunakan Istilah." },
  { "en": "Apa Itu Logika Predikat Fuzzy?", "id": "Ekstensi Logika Fuzzy." },
  { "en": "Apa Itu Himpunan Kosong Fuzzy?", "id": "Derajat Keanggotaan Selalu Nol." },
  { "en": "Apa Itu Himpunan Universal Fuzzy?", "id": "Derajat Keanggotaan Selalu Satu." },
  { "en": "Apa Itu Subset Fuzzy?", "id": "Himpunan A Subset B Jika." },
  { "en": "Apa Itu Kesetaraan Himpunan Fuzzy?", "id": "Dua Himpunan Sama Jika." },
  { "en": "Apa Itu Kontrol Proporsional-Integral-Derivatif (PID) Fuzzy?", "id": "Kontroler PID Dengan Aturan Fuzzy." },
  { "en": "Apa Itu Tsukamoto Fuzzy Model?", "id": "Model Fuzzy Dengan Konsekuen Monotonik." },
  { "en": "Apa Itu Metode Mean of Maximum (MOM)?", "id": "Metode Defuzzifikasi Rata-rata Nilai Maksimum." },
  { "en": "Apa Itu Metode Smallest of Maximum (SOM)?", "id": "Memilih Nilai Terkecil Dari Output Maksimum." },
  { "en": "Apa Itu Metode Largest of Maximum (LOM)?", "id": "Memilih Nilai Terbesar Dari Output Maksimum." },
  { "en": "Apa Itu Metode Bisector?", "id": "Membagi Area Himpunan Fuzzy Menjadi Dua." },
  { "en": "Apa Itu Weighted Average Method?", "id": "Metode Rata-rata Tertimbang Untuk Defuzzifikasi." },
  { "en": "Metode Defuzzifikasi Mana Yang Digunakan Sugeno?", "id": "Metode Weighted Average." },
  { "en": "Apa Itu Himpunan Fuzzy Interval Tipe-2?", "id": "Batas Atas Dan Bawahnya Adalah Himpunan." },
  { "en": "Apa Itu Footprint of Uncertainty (FOU)?", "id": "Area Ketidakpastian Dalam Himpunan Fuzzy." },
  { "en": "Apa Itu Type-Reduction?", "id": "Proses Mengubah Himpunan Tipe-2 Menjadi Tipe-1." },
  { "en": "Apa Itu Kontroler Logika Fuzzy?", "id": "Sistem Kontrol Yang Menggunakan Logika Fuzzy." },
  { "en": "Apa Itu Input Kontroler Fuzzy?", "id": "Biasanya Error Dan Perubahan Error." },
  { "en": "Apa Itu Output Kontroler Fuzzy?", "id": "Sinyal Kontrol Untuk Proses." },
  { "en": "Apa Itu Sistem Mamdani?", "id": "Nama Lain Untuk Model Fuzzy Mamdani." },
  { "en": "Apa Itu Sistem Takagi-Sugeno?", "id": "Nama Lain Untuk Model Fuzzy Sugeno." },
  { "en": "Apa Itu Sistem Fuzzy Murni?", "id": "Sistem Yang Sepenuhnya Berbasis Logika Fuzzy." },
  { "en": "Apa Itu Sistem Hibrida?", "id": "Menggabungkan Logika Fuzzy Dengan Teknik Lain." },
  { "en": "Apa Itu Tabel Aturan Fuzzy?", "id": "Representasi Matriks Dari Basis Aturan." },
  { "en": "Apa Itu Aturan Fuzzy?", "id": "Pernyataan JIKA-MAKA Yang Mendeskripsikan." },
  { "en": "Bagaimana Aturan Fuzzy Dibuat?", "id": "Berdasarkan Pengetahuan Ahli Atau Data." },
  { "en": "Apa Itu Data Mining?", "id": "Mengekstrak Aturan Fuzzy Dari Data." },
  { "en": "Apa Itu Fuzzy Set Theory?", "id": "Teori Matematika Di Balik Logika Fuzzy." },
  { "en": "Apa Itu Fuzziness?", "id": "Ukuran Ketidakjelasan Atau Ambiguitas." },
  { "en": "Apa Itu Ambiguitas?", "id": "Memiliki Lebih Dari Satu Interpretasi." },
  { "en": "Apa Itu Ketidakpastian?", "id": "Kurangnya Informasi Atau Pengetahuan." },
  { "en": "Apakah Fuzziness Sama Dengan Probabilitas?", "id": "Tidak, Keduanya Adalah Konsep Yang Berbeda." },
  { "en": "Apa Itu Probabilitas?", "id": "Ukuran Kemungkinan Terjadinya Suatu Peristiwa." },
  { "en": "Apa Itu Fuzzy Logic Toolbox?", "id": "Perangkat Lunak Untuk Mendesain Sistem Fuzzy." },
  { "en": "Di Software Apa Toolbox Ini Ada?", "id": "Di MATLAB." },
  { "en": "Apa Itu Himpunan Kosong?", "id": "Himpunan Yang Tidak Memiliki Anggota." },
  { "en": "Apa Itu Himpunan Semesta?", "id": "Himpunan Semua Elemen Yang Mungkin." },
  { "en": "Apa Itu Subset?", "id": "Himpunan Yang Terkandung Dalam Himpunan." },
  { "en": "Apa Itu Power Set?", "id": "Himpunan Semua Subset." },
  { "en": "Apa Itu Kardinalitas?", "id": "Jumlah Elemen Dalam Himpunan." },
  { "en": "Apa Itu Himpunan Fuzzy Singleton?", "id": "Himpunan Fuzzy Dengan Satu Anggota." },
  { "en": "Apa Itu Himpunan Fuzzy Kosong?", "id": "Fungsi Keanggotaan Selalu Nol." },
  { "en": "Apa Itu Himpunan Fuzzy Universal?", "id": "Fungsi Keanggotaan Selalu Satu." },
  { "en": "Apa Itu Inklusi Fuzzy?", "id": "Konsep Subset Dalam Himpunan Fuzzy." },
  { "en": "Apa Itu Prinsip Ketidaksesuaian?", "id": "Semakin Kompleks Sistem, Semakin." },
  { "en": "Apa Itu Granular Computing?", "id": " paradigma Komputasi Berbasis Granula." },
  { "en": "Apa Itu Granula?", "id": "Gumpalan Objek Yang Tidak Dapat." },
  { "en": "Apa Itu Rough Set Theory?", "id": "Pendekatan Matematis Untuk Ketidakpastian." },
  { "en": "Apa Itu Aproksimasi Bawah?", "id": "Elemen Yang Pasti Anggota." },
  { "en": "Apa Itu Aproksimasi Atas?", "id": "Elemen Yang Mungkin Anggota." },
  { "en": "Apa Itu Wilayah Batas?", "id": "Perbedaan Antara Aproksimasi Atas." },
  { "en": "Apa Itu Pengenalan Pola?", "id": "Mengidentifikasi Pola Dalam Data." },
  { "en": "Bagaimana Logika Fuzzy Digunakan?", "id": "Untuk Klasifikasi Berbasis Aturan." },
  { "en": "Apa Itu Fuzzy Clustering?", "id": "Nama Lain Untuk Klastering Fuzzy." },
  { "en": "Apa Itu Pemrosesan Gambar Fuzzy?", "id": "Menggunakan Logika Fuzzy Untuk." },
  { "en": "Apa Itu Peningkatan Kontras Fuzzy?", "id": "Meningkatkan Kontras Gambar." },
  { "en": "Apa Itu Deteksi Tepi Fuzzy?", "id": "Mendeteksi Tepi Dalam Gambar." },
  { "en": "Apa Itu Sistem Kontrol Fuzzy Adaptif?", "id": "Kontroler Yang Aturannya Dapat." },
  { "en": "Apa Itu Pembelajaran Penguatan Fuzzy?", "id": "Menggabungkan Fuzzy Logic Dan Reinforcement." },
  { "en": "Apa Itu Fuzzy Time Series?", "id": "Analisis Runtun Waktu Dengan." },
  { "en": "Apa Itu Peramalan Fuzzy?", "id": "Membuat Prediksi Menggunakan Model." },
  { "en": "Apa Itu Sistem Inferensi Neuro-Fuzzy?", "id": "Nama Lain Untuk Jaringan." },
  { "en": "Apa Itu Lapisan Input?", "id": "Menerima Variabel Input." },
  { "en": "Apa Itu Lapisan Fuzzifikasi?", "id": "Menghitung Derajat Keanggotaan." },
  { "en": "Apa Itu Lapisan Aturan?", "id": "Mengevaluasi Antecedent Dari Aturan." },
  { "en": "Apa Itu Lapisan Defuzzifikasi?", "id": "Menghitung Output Akhir." },
  { "en": "Apa Itu Algoritma Pelatihan Hibrida?", "id": "Menggabungkan Beberapa Metode." },
  { "en": "Apa Itu Proposisi Fuzzy?", "id": "Pernyataan Yang Mungkin Benar." },
  { "en": "Apa Itu Kuantifier Fuzzy?", "id": "Seperti 'Beberapa', 'Banyak', 'Sedikit'." },
  { "en": "Apa Itu Kestabilan Sistem Kontrol?", "id": "Kemampuan Sistem Untuk Kembali." },
  { "en": "Apa Itu Analisis Kestabilan Lyapunov?", "id": "Metode Matematis Untuk Menganalisis." },
  { "en": "Apa Itu Kontroler PID (Proportional-Integral-Derivative)?", "id": "Kontroler Umpan Balik Klasik." },
  { "en": "Apa Itu Self-Tuning Fuzzy PID?", "id": "Kontroler PID Dimana Parameter." },
  { "en": "Apa Itu Aturan Fuzzy Sugeno Orde Nol?", "id": "Konsekuen Adalah Nilai Konstan." },
  { "en": "Apa Itu Aturan Fuzzy Sugeno Orde Satu?", "id": "Konsekuen Adalah Fungsi Linier." },
  { "en": "Apa Itu Metode Mamdani?", "id": "Nama Lain Untuk Model Fuzzy." },
  { "en": "Apa Itu Fungsi Implikasi Min?", "id": "Memotong Output Fuzzy." },
  { "en": "Apa Itu Fungsi Implikasi Dot?", "id": "Menskalakan Output Fuzzy." },
  { "en": "Apa Itu Permukaan Kontrol?", "id": "Plot 3D Dari Perilaku." },
  { "en": "Apa Itu Logika Klasik (Boolean)?", "id": "Logika Berbasis Nilai Benar." },
  { "en": "Apa Itu The Law of Excluded Middle?", "id": "Sesuatu Benar Atau Salah." },
  { "en": "Apakah Hukum Ini Berlaku Di Logika Fuzzy?", "id": "Tidak, Sesuatu Bisa Parsial." },
  { "en": "Apa Itu The Law of Non-Contradiction?", "id": "Sesuatu Tidak Bisa Benar." },
  { "en": "Apakah Hukum Ini Berlaku Di Logika Fuzzy?", "id": "Ya, Pada Dasarnya Masih." },
  { "en": "Apa Itu Sistem Berbasis Aturan?", "id": "Sistem Yang Menggunakan Aturan." },
  { "en": "Apa Itu Basis Pengetahuan?", "id": "Penyimpanan Fakta Dan Aturan." },
  { "en": "Apa Itu Mesin Inferensi?", "id": "Menerapkan Aturan Ke Fakta." },
  { "en": "Apa Itu Penalaran Monotonik?", "id": "Menambah Fakta Baru Tidak." },
  { "en": "Apa Itu Penalaran Non-Monotonik?", "id": "Kesimpulan Dapat Ditarik Kembali." },
  { "en": "Apa Itu Logika Default?", "id": "Bentuk Penalaran Non-Monotonik." },
  { "en": "Apa Itu Fuzzy Set Ordinal?", "id": "Himpunan Fuzzy Dengan Elemen." },
  { "en": "Apa Itu Fuzzy Graph?", "id": "Graf Dimana Bobot Tepi." },
  { "en": "Apa Itu Fuzzy Automata?", "id": "Mesin Keadaan Finit Dengan." },
  { "en": "Apa Itu Bahasa Fuzzy?", "id": "Himpunan String Dengan Derajat." },
  { "en": "Apa Itu Partisi Krisp?", "id": "Membagi Himpunan Menjadi." },
  { "en": "Apa Itu Partisi Fuzzy?", "id": "Membagi Himpunan Dengan Tumpang." },
  { "en": "Apa Itu Kompleksitas Komputasi?", "id": "Ukuran Sumber Daya Yang Dibutuhkan." },
  { "en": "Apa Itu Perangkat Keras Fuzzy?", "id": "Chip Khusus Untuk Logika." },
  { "en": "Apa Keuntungan Perangkat Keras Fuzzy?", "id": "Pemrosesan Sangat Cepat." },
  { "en": "Apa Itu Prosesor Fuzzy?", "id": "Prosesor Yang Dirancang Untuk." },
  { "en": "Apa Itu Logika Intuitif?", "id": "Logika Yang Tidak Menerima." },
  { "en": "Apa Itu Logika Multi-Nilai?", "id": "Logika Dengan Lebih Dari." },
  { "en": "Apakah Logika Fuzzy Termasuk Logika Multi-Nilai?", "id": "Ya, Itu Adalah Kasus." },
